...
def request_by_url():
    toekn = "7dd545716c795c4f306b06ace901bbb2"
    url = "https://availability-api.hkexpress.com/api/v1.0/availability/dayavailability?token=" + toekn + "&outboundDate=2023-09-05"
    headers = {
